...
### スキップ数をカウントアップ
execute if data storage close_detector: {_:true} store result storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].close_detector.skip int -1 run data get storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].close_detector.skip -1.0000000001
