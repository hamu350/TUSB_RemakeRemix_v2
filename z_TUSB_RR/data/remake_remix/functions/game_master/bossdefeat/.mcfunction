#> remake_remix:game_master/bossdefeat/
#
# ボスが敗北した時実行
...
schedule clear remake_remix:game_master/bosswin/end

data modify storage tusb_remake: game_master.live set value 0b

forceload add -2950 -71 -3000 -11

function remake_remix:game_master/allkill
...
# 報酬配置
function remake_remix:game_master/bossdefeat/reward
