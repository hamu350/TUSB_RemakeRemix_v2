#> remake_remix:enemy/skill/game_master/5/blast
#
# 
#
# @within function remake_remix:enemy/skill/game_master/5/
...
# loop
    ...
    execute if score _ blast matches 1.. run schedule function remake_remix:enemy/skill/game_master/5/blast 1s
