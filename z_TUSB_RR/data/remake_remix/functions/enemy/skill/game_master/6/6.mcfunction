#> remake_remix:enemy/skill/game_master/6/6
#
# 
#
# @within function remake_remix:enemy/skill/game_master/6/
...
# solo
    execute if score _ game_master.reward matches 1 run function remake_remix:enemy/skill/game_master/6/6.solo
# multi
    execute if score _ game_master.reward matches 2.. run function remake_remix:enemy/skill/game_master/6/6.multi
