#> remake_remix:enemy/skill/game_master/6
#
# 
#
...
# 1-5
    execute as @e[limit=1,tag=GM] run execute if score @s Random matches 0..4 run schedule function remake_remix:enemy/skill/game_master/6/1_5 3s
# 6
    execute as @e[limit=1,tag=GM] run execute if score @s Random matches 5 run schedule function remake_remix:enemy/skill/game_master/6/6 3s
