#> tusb_remake:skill/ninja/Syungoku/punch/apply
### 流し斬りがヒットした敵に効果をかける
...
execute if score @s Syungoku matches 1 as @e[distance=..15,type=#tusb_remake:mob,tag=Enemy] run function score_damage:api/attack
execute if score @s Syungoku matches 2 as @e[distance=..15,type=#tusb_remake:mob,tag=Enemy] run function score_damage:api/attack
execute if score @s Syungoku matches 3 as @e[distance=..15,type=#tusb_remake:mob,tag=Enemy] run function score_damage:api/attack
execute if score @s Syungoku matches 4 as @e[distance=..15,type=#tusb_remake:mob,tag=Enemy] run function score_damage:api/attack
execute if score @s Syungoku matches 5 as @e[distance=..15,type=#tusb_remake:mob,tag=Enemy] run function score_damage:api/attack
