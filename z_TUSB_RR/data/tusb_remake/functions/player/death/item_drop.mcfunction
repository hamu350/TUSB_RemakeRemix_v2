#> tusb_remake:player/death/item_drop
#
# アイテムをぶちまける
#
# @within function tusb_remake:player/death/

# インベ保存
    function api_tusb:data_get/inventory
...
# 共鳴処理
    execute if data storage api: Inventory[{tag:{Kyoumei:1b}}] run function tusb_remake:player/death/kyoumei/
