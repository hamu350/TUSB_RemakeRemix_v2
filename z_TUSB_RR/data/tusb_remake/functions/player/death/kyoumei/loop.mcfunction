#> tusb_remake:player/death/kyoumei/loop
#
# 
#
# @within function tusb_remake:player/death/kyoumei/
...
# ループ処理
    execute if data storage remake_remix: Inventory[0] run function tusb_remake:player/death/kyoumei/loop
