...
### 新ディメ
execute positioned -77 263 -84 align xyz if entity @s[dx=0] if entity @s[advancements={tusb_remake:press={new_dimension=false}}] run function remake_remix:new_dimension/description
execute positioned -77 263 -84 align xyz if entity @s[dx=0] run advancement grant @s only tusb_remake:press new_dimension
