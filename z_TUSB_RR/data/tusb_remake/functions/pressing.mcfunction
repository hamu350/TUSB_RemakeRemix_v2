...
execute if entity @s[advancements={tusb_remake:press={new_dimension=true}}] if predicate tusb_remake:area/skyland positioned -77 263 -84 align xyz unless entity @s[dx=0] run advancement revoke @s only tusb_remake:press new_dimension
