...
execute unless score _ TUSB matches 15.. run tag @s[scores={AreaChangeFlag=11},gamemode=!creative,gamemode=!spectator] add NotCaptureIsland
...
tp @s[scores={AreaChangeFlag=11},tag=BringItemError] -144 51 70 270 0
tp @s[scores={AreaChangeFlag=11},tag=NotCaptureIsland] -144 51 70 270 0
### ネザーアスレチックに移動した時
