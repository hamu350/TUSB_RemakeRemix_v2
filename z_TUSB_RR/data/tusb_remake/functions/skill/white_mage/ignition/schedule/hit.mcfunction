#> tusb_remake:skill/white_mage/ignition/schedule/hit

### マルチヒット防止のエフェクト
effect give @s minecraft:saturation 10 127 true

execute if entity @s[type=#tusb_remake:undead] run effect give @s minecraft:instant_health 1 8 true
execute unless entity @s[type=#tusb_remake:undead] run effect give @s minecraft:instant_damage 1 8 true
