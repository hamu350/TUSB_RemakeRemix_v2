...
execute if entity @s[tag=!GM,tag=!GMend] if score _ ActivatedSkill matches 1240 if predicate tusb_remake:random/1/3 run item replace entity @s weapon.mainhand with minecraft:air
execute if entity @s[tag=!GM,tag=!GMend] if score _ ActivatedSkill matches 1241..1249 unless predicate tusb_remake:random/1/3 run item replace entity @s weapon.mainhand with minecraft:air
