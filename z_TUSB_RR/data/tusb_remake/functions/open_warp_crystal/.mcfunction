...
## テーブルマウンテン
### 入口へのワープクリスタルを開くコマブロ
execute in minecraft:overworld positioned 30 2 -2149 if block ~ ~ ~ minecraft:command_block{powered:true} run function tusb_remake:area/portal/table_mountain/entrance/open
