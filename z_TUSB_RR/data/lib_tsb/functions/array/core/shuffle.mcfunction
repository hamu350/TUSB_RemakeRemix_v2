...
execute if score $Index Lib matches 1.. run function lib_tsb:array/core/move
...
execute if score $ListSize Lib matches 1.. run function lib_tsb:array/core/shuffle