...
data modify storage asset: mob set value {Passengers: [{CustomName: '{"text":"鋭角様"}', Health: 450.0f, ArmorItems: [{id: "minecraft:leather_boots", Count: 65b, tag: {RepairCost: 1000000000, display: {color: 16772608, Name: '{"text":"チェイサーの靴"}'}, Enchantments: [{lvl: 10s, id: "minecraft:fire_protection"}, {lvl: 10s, id: "minecraft:feather_falling"}, {lvl: 10s, id: "minecraft:blast_protection"}], Damage: 0}}, {id: "minecraft:leather_leggings", Count: 65b, tag: {RepairCost: 1000000000, display: {color: 16772608, Name: '{"text":"チェイサーのズボン"}'}, Enchantments: [{lvl: 10s, id: "minecraft:fire_protection"}, {lvl: 10s, id: "minecraft:feather_falling"}, {lvl: 10s, id: "minecraft:blast_protection"}], Damage: 0}}, {id: "minecraft:leather_chestplate", Count: 65b, tag: {RepairCost: 1000000000, display: {color: 16772608, Name: '{"text":"チェイサーの服"}'}, Enchantments: [{lvl: 10s, id: "minecraft:fire_protection"}, {lvl: 10s, id: "minecraft:feather_falling"}, {lvl: 10s, id: "minecraft:blast_protection"}], Damage: 0}}, {id: "minecraft:dragon_egg", Count: 65b, tag: {RepairCost: 1000000000, Enchantments: [{lvl: 10s, id: "minecraft:blast_protection"}]}}], Attributes: [{Base: 450.0d, Name: "generic.max_health"}, {Base: 1.0d, Name: "generic.knockback_resistance"}], id: "minecraft:skeleton", ActiveEffects: [{ShowParticles: 0b, Duration: 2000000000, Id: 14b, Amplifier: 1b}], CustomNameVisible: 1b, HandItems: [{id: "minecraft:bow", Count: 65b, tag: {RepairCost: 1000000000, display: {Name: '{"text":"チェイサーの弓"}'}, Enchantments: [{lvl: 35s, id: "minecraft:power"}, {lvl: 15s, id: "minecraft:punch"}], Damage: 0}}]}], Health: 0.0f, DeathTime: 19s, Xp: 0, VillagerData: {profession: "minecraft:farmer", level: 1, type: "minecraft:plains"}, id: "minecraft:villager"}
