#> mob_manager:boss/newstar_king/skill/time_realization/version/1_11
...
schedule function mob_manager:boss/newstar_king/skill/time_realization/version/1_11_damage_target 10t