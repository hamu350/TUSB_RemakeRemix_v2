#> mob_manager:boss/newstar_king/skill/time_realization/version/1_15
...
schedule function mob_manager:boss/newstar_king/skill/time_realization/version/1.15/condition_check 1t