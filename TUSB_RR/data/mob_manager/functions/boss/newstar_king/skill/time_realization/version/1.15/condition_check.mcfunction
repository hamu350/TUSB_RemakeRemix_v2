#> mob_manager:boss/newstar_king/skill/time_realization/version/1.15/condition_check
...
# execute as @e[type=bee,tag=1_15_bee] at @s if entity @a[dx=1,dy=1,dz=1] run function mob_manager:boss/newstar_king/skill/time_realization/version/1.15/damage

# execute as @e[type=bee,tag=1_15_bee] at @s positioned ~-0.25 ~ ~-0.25 if entity @e[type=player,dx=1,dz=1] run execute positioned ~0.25 ~ ~0.25 as @e[type=player,dx=-1,dz=-1] run function mob_manager:boss/newstar_king/skill/time_realization/version/1.15/damage
# これで検知できてるわ

execute as @e[type=bee,tag=1_15_bee] at @s as @a[distance=..1] run function mob_manager:boss/newstar_king/skill/time_realization/version/1.15/damage
...
# 予約
execute if entity @e[type=bee,tag=1_15_bee] run schedule function mob_manager:boss/newstar_king/skill/time_realization/version/1.15/condition_check 1t
