#> mob_manager:boss/newstar_king/skill/acceralation/schedule_result
...
# 演出
execute at @e[type=marker,tag=acceralation] run function mob_manager:boss/newstar_king/skill/acceralation/particle


# 上のやつちょっとの猶予時間の後にどーんってやってもいいよなぁ
# 起点マーカーだしてschedule,その後範囲指定してkillかねー

schedule function mob_manager:boss/newstar_king/skill/acceralation/detect 10t
