#> mob_manager:boss/newstar_king/skill/summon_blackhole/result
...
execute at @e[type=marker,tag=Blackhole] run function mob_manager:boss/newstar_king/skill/summon_blackhole/particle/