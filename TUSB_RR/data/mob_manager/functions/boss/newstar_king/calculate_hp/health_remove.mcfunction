#> mob_manager:boss/newstar_king/calculate_hp/health_remove
...
# 君毎回動いてるね
# どうにかならんか?
execute if score $percent_10 Boss_x > $Temp Boss_Health run execute as @e[type=zombie,tag=NewStar_King,limit=1] at @s run function mob_manager:boss/newstar_king/calculate_hp/percent_change
