#> mob_manager:boss/newstar_king/calculate_hp/check_hp
...
execute if score $Current_Health Boss_Health matches ..102399 run function mob_manager:boss/newstar_king/calculate_hp/health_remove