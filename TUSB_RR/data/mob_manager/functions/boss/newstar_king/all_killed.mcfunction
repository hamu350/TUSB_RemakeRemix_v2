#> mob_manager:boss/newstar_king/all_killed

# どっちの王もキルされちゃった；；
execute in minecraft:the_end run setblock 501 100 498 command_block{conditionMet: 0b, auto: 0b, CustomName: '{"text":"@"}', powered: 0b, Command: "function mob_manager:boss/newstar_king/makeup/", x: 501, y: 100, z: 498, id: "minecraft:command_block", SuccessCount: 0, TrackOutput: 1b, UpdateLastExecution: 1b}
