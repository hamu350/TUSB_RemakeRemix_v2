#> mob_manager:boss/game_master/bossdefeat/
#
# ボスが敗北した時実行
...
schedule clear mob_manager:boss/game_master/bosswin/end

data modify storage tusb_remake: game_master.live set value 0b

forceload add -2950 -71 -3000 -11

function mob_manager:boss/game_master/allkill

# ボスボタン配置
setblock -2990 71 -41 light_weighted_pressure_plate

# 帰還看板配置
setblock -2983 70 -41 minecraft:warped_sign[rotation=4]{Text1:'{"text":"","clickEvent":{"action":"run_command","value":"/function remake_remix:sign_event/game_master/boss_area"}}',Text2:'{"text":"\\u5e30\\u9084","bold":true,"color":"#FFFFFF"}',Text3:'{"text":"\\u203b\\u30a2\\u30a4\\u30c6\\u30e0\\u306f","bold":true,"color":"red"}',Text4:'{"text":"\\u6301\\u3061\\u5e30\\u308c\\u307e\\u305b\\u3093","bold":true,"color":"red"}'}

# 敵消し
execute as @e[type=armor_stand,tag=Boss_MarkerC] at @s run tag @e[distance=..60,tag=Enemy] add Garbage

# 報酬配置
function mob_manager:boss/game_master/bossdefeat/reward
