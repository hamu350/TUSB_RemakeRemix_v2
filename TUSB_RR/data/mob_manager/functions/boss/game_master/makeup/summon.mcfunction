#> mob_manager:boss/newstar_king/makeup/summon
#
#> 出現時演出
...
execute at @e[type=armor_stand,tag=Boss_MarkerC] positioned ~ ~2 ~ run function mob_manager:boss/game_master/spawn
