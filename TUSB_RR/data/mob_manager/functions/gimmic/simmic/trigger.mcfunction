#> world_manager:gimmic/simmic/trigger
# シミック
### Copyright © 2022 赤石愛
...
fill ~-10 ~-10 ~-10 ~10 ~10 ~10 minecraft:command_block{Command:"function world_manager:gimmic/simmic/summon",auto:true} replace minecraft:chain_command_block{Command:"シミック"}
...
advancement revoke @s only world_manager:gimmic/simmic/trigger
