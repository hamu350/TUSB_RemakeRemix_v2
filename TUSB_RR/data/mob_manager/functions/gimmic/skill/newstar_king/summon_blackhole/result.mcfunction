#> mob_manager:gimmic/skill/newstar_king/summon_blackhole/result
...
execute at @e[type=marker,tag=Blackhole] run function mob_manager:gimmic/skill/newstar_king/summon_blackhole/particle/