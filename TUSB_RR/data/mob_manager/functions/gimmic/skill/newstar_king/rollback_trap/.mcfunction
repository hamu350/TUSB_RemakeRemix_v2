#> mob_manager:gimmic/skill/newstar_king/rollback_trap/
...
schedule function mob_manager:gimmic/skill/newstar_king/rollback_trap/check_arrow_ground 2t replace