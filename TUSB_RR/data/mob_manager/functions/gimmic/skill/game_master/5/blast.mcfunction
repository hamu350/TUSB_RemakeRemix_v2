#> mob_manager:gimmic/skill/game_master/5/blast
#
# 
#
# @within function mob_manager:gimmic/skill/game_master/5/
...
# loop
    ...
    execute if score _ blast matches 1.. run schedule function mob_manager:gimmic/skill/game_master/5/blast 1s
