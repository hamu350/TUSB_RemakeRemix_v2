#> mob_manager:gimmic/skill/game_master/6/6
#
# 
#
# @within function mob_manager:gimmic/skill/game_master/6/
...
# solo
    execute if score _ game_master.reward matches 1 run function mob_manager:gimmic/skill/game_master/6/6.solo
# multi
    execute if score _ game_master.reward matches 2.. run function mob_manager:gimmic/skill/game_master/6/6.multi
