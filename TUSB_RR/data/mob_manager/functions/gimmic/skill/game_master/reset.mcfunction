#> mob_manager:gimmic/skill/game_master/reset
#
# 
#
...
# UNOしていないプレイヤーがいたらダメージを与える
    execute as @a[distance=..60,tag=UNO] run function mob_manager:gimmic/skill/game_master/attack60
# tag remove
    tag @a remove UNO
...
# 周囲のプレイヤーに攻撃
    execute at @e[tag=GM7] as @a[distance=..30,tag=GameMasterBattle] run function mob_manager:gimmic/skill/game_master/attack77.7
# GM7を削除
