#> mob_manager:gimmic/skill/shinsei/acceleration
#
#> 新星様のスキル
#
#> 時計島タイマーを起動させ時を加速させる
...
execute in minecraft:overworld run schedule function world_manager:dimension/skylands/clock/half_tick 10t
# msg
