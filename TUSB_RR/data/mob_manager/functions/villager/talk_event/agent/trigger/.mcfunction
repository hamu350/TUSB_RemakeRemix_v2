#> mob_manager:villager/talk_event/agent/trigger/
# エージェントとの会話処理
### Copyright © 2022 赤石愛
### This software is released under the MIT License, see LICENSE.

### エージェントの近くでYESと答えていたらOK
execute if entity @e[distance=..6,type=villager,tag=Agent,limit=1] run function mob_manager:villager/talk_event/agent/trigger/yes
