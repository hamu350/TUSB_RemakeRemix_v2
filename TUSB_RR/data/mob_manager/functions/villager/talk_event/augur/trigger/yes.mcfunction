#> mob_manager:villager/talk_event/augur/trigger/yes
# 占い師との会話処理
### Copyright © 2022 赤石愛
...
## 占いコスト足りてたらお支払い
execute if data storage tusb_remake: {paid:true} run function mob_manager:villager/talk_event/augur/trigger/tell
