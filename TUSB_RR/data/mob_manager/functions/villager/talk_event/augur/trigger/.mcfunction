#> mob_manager:villager/talk_event/augur/trigger/
# 占い師との会話処理
### Copyright © 2022 赤石愛
### This software is released under the MIT License, see LICENSE.

### 占い師の近くでYESと答えていたらOK
execute if entity @e[distance=..6,type=villager,tag=Augur,limit=1] run function mob_manager:villager/talk_event/augur/trigger/yes
