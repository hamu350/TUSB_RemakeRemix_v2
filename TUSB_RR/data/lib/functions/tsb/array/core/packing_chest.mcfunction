#> lib:tsb/array/core/packing_chest
#
#
#
# @within function
#   lib:tsb/array/core/packing_chest
#   lib:tsb/array/packing_chest
...
# ループ処理
    ...
    execute if score $Index Temporary < $27 Const if data storage lib: Array[0] run function lib:tsb/array/core/packing_chest