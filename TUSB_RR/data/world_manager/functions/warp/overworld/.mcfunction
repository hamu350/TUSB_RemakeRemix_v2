...
### スキル設定場からエクストラドメイン
execute positioned -2722 89 -268 align xyz if entity @s[dx=0,dy=0,dz=0] run function world_manager:warp/overworld/extra/enter
### エクストラドメインからスキル設定場
...
execute positioned 58 66 702 align xyz if entity @s[dx=0] unless entity @e[dx=0,type=item,tag=SealBreakerItem] positioned ~0.5 ~ ~0.5 run function world_manager:warp/overworld/gullivers_land/red
execute positioned 131 63 774 align xyz if entity @s[dx=0] unless entity @e[dx=0,type=item,tag=SealBreakerItem] positioned ~0.5 ~ ~0.5 run function world_manager:warp/overworld/gullivers_land/blue
...
### コオリトカス
execute positioned 203 147 -20 align xyz if entity @s[dx=0] if entity @s[advancements={player_manager:block_interact/press={unlock_tocult=false}}] run function world_manager:warp/overworld/unlock_tocult/
