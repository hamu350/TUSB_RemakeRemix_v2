...
### 木製以外の感圧板を踏んでる
execute if block ~-0.238 ~0.75 ~-0.238 #lib:pressure_plate unless block ~-0.238 ~0.75 ~-0.238 #lib:pressure_plate[power=0] run data modify storage tusb_remake: press set value true
execute if block ~0.238 ~0.75 ~-0.238 #lib:pressure_plate unless block ~0.238 ~0.75 ~-0.238 #lib:pressure_plate[power=0] run data modify storage tusb_remake: press set value true
execute if block ~-0.238 ~0.75 ~0.238 #lib:pressure_plate unless block ~-0.238 ~0.75 ~0.238 #lib:pressure_plate[power=0] run data modify storage tusb_remake: press set value true
execute if block ~0.238 ~0.75 ~0.238 #lib:pressure_plate unless block ~0.238 ~0.75 ~0.238 #lib:pressure_plate[power=0] run data modify storage tusb_remake: press set value true
...
advancement revoke @s only world_manager:warp/iron
advancement revoke @s only world_manager:warp/gold
advancement revoke @s only world_manager:warp/stone
