#> world_manager:dimension/purgatory/boss/left_beam/schedule
# 左目からのビーム
### Copyright © 2022 赤石愛
...
execute if data storage tusb_remake: {_:true} in minecraft:overworld run schedule function world_manager:dimension/purgatory/boss/left_beam/schedule 1t
