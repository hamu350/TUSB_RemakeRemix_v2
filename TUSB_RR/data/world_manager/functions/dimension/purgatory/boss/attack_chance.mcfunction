#> world_manager:dimension/purgatory/boss/attack_chance
# ネザーボスもアタックチャーンス！！！
### Copyright © 2022 赤石愛
...
#* ネザーボス攻撃
execute as 0-0-1-0-4 at @s positioned ~ ~-30 ~74 if entity @p[distance=..32] run function world_manager:dimension/purgatory/boss/fire_breath/
execute as 0-0-1-0-4 at @s positioned ~-21 ~-10 ~22 if entity @p[dx=53,dy=5,dz=31] run function world_manager:dimension/purgatory/boss/lightning_bolt/
...
execute if data storage tusb_remake: {_:true} run function world_manager:dimension/purgatory/boss/right_beam/
### 左目からのビームを出すかどうかチェック
data modify storage tusb_remake: _ set value false
execute as 0-0-1-0-4 at @s positioned ~ ~-30 ~74 run execute as @p[distance=29..,dx=50,dy=30,dz=-50] at @s run data modify storage tusb_remake: _ set value true
execute as 0-0-1-0-4 at @s positioned ~ ~-30 ~74 run execute as @p[distance=29..,dx=50,dy=30,dz=50] at @s run data modify storage tusb_remake: _ set value true
execute if data storage tusb_remake: {_:true} run function world_manager:dimension/purgatory/boss/left_beam/
