#> world_manager:dimension/purgatory/boss/clear
# ネザーボスの攻撃タイミングの確認
### Copyright © 2022 赤石愛
...
### チャンクロード
execute in minecraft:the_nether positioned -5 1 -34 run function core:load_chunk
execute in minecraft:the_nether positioned -5 1 -24 run function core:load_chunk
execute in minecraft:the_nether positioned 5 1 -34 run function core:load_chunk
execute in minecraft:the_nether positioned 5 1 -24 run function core:load_chunk
### ここでクリアポータルを出す
