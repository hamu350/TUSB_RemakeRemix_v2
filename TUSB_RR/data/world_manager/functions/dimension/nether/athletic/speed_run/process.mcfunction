#> world_manager:dimension/nether/athletic/speed_run/process
# スピードラン
### Copyright © 2022 赤石愛
...
# ステージが最後まで進んだら停止させる
execute as 0-0-4-0-4 at @s if block ~ ~ ~ minecraft:air run schedule clear world_manager:dimension/nether/athletic/speed_run/schedule
# エフェクトかけなおし
