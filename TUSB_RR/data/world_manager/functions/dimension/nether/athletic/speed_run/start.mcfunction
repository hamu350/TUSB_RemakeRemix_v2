#> world_manager:dimension/nether/athletic/speed_run/start
# スピードラン開始
### Copyright © 2022 赤石愛
...
### スケジュール有効化
execute in minecraft:overworld run schedule function world_manager:dimension/nether/athletic/speed_run/schedule 2s replace
