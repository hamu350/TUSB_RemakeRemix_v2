#> world_manager:dimension/nether/athletic/pattern6/count_up/1
# パターン６
### Copyright © 2022 赤石愛
...
execute in minecraft:overworld run schedule function world_manager:dimension/nether/athletic/pattern6/count_up/2 2s
