#> world_manager:dimension/nether/athletic/hell_climb/schedule
# ヘルクライム
### Copyright © 2022 赤石愛
...
## 終わっていなければ再度スケジュール
execute as 0-0-4-0-1 at @s positioned ~ ~ ~ if block ~ ~ ~ minecraft:lime_stained_glass run schedule function world_manager:dimension/nether/athletic/hell_climb/schedule 7s
## 終わっていなければ進める
execute as 0-0-4-0-1 at @s positioned ~ ~ ~ if block ~ ~ ~ minecraft:lime_stained_glass run tp 0-0-4-0-1 ~-6 ~ ~

## 頭上の砂が落ち始めたらデータを修正
schedule function world_manager:dimension/nether/athletic/hell_climb/schedule2 2t
