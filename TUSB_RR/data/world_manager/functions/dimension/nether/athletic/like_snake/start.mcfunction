#> world_manager:dimension/nether/athletic/like_snake/start
# スピードラン開始
### Copyright © 2022 赤石愛
...
### トロッコ１
execute in minecraft:overworld run schedule function world_manager:dimension/nether/athletic/like_snake/start1 2.0s

### トロッコ２
execute in minecraft:overworld run schedule function world_manager:dimension/nether/athletic/like_snake/start2 4.5s
