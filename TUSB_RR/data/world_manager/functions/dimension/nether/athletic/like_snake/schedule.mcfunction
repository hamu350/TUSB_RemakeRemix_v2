#> world_manager:dimension/nether/athletic/like_snake/schedule
# スピードラン
### Copyright © 2022 赤石愛
...
### 再度スケジュール
execute in minecraft:overworld run schedule function world_manager:dimension/nether/athletic/like_snake/schedule 1t
...
execute unless entity 0-0-4-0-6 unless entity 0-0-4-0-7 in minecraft:overworld run schedule clear world_manager:dimension/nether/athletic/like_snake/schedule
