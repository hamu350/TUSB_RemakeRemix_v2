#> world_manager:dimension/skylands/clock/half_tick
#
# 時計島がおかしくなってる間の演出
#
...
# 止まるまで繰り返し
execute unless score Cloak Changed_Form matches 0 in minecraft:overworld run schedule function world_manager:dimension/skylands/clock/half_tick 10t
