#> world_manager:dimension/skylands/clock/0
# 時計島起動前
### Copyright © 2022 赤石愛
...
### 時計島変身
execute in minecraft:overworld positioned 4001 70 4001 run function world_manager:dimension/skylands/clock/clone
