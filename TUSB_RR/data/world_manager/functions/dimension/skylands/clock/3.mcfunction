#> world_manager:dimension/skylands/clock/3
# 時計島第３形態
### Copyright © 2022 赤石愛
...
### 時計島変身
execute in minecraft:overworld positioned 4001 1 4001 run function world_manager:dimension/skylands/clock/clone
