#> world_manager:dimension/skylands/clock/2
# 時計島第２形態
### Copyright © 2022 赤石愛
...
### 時計島変身
execute in minecraft:overworld positioned 4001 24 4001 run function world_manager:dimension/skylands/clock/clone
