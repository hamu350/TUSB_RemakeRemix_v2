#> skill:job_skill/archer/poof_trap/schedule/check
### ニフラムトラップの効果判定
### Copyright © 2022 赤石愛
...
execute as @e[distance=..5,type=#lib:mob,tag=Poofable,sort=random,limit=3] run function skill:job_skill/archer/poof_trap/schedule/apply
