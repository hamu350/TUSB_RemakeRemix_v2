...
execute as @e[tag=crazy] at @s run function skill:job_skill/archer/crazy/otomitame
...
execute if data storage tusb_remake: {_:true} in minecraft:overworld run schedule function skill:job_skill/archer/crazy/hit 20t
