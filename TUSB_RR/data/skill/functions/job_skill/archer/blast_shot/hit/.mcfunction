#> skill:job_skill/archer/blast_shot/hit/
# ブラストショットが直接当たった時
...
execute if score _ PotentialSkill matches 3230 as @e[distance=..3,type=#lib:mob,tag=Enemy] run function skill:job_skill/archer/blast_shot/hit/damage1
execute if score _ PotentialSkill matches 3231..3239 as @e[distance=..6,type=#lib:mob,tag=Enemy] run function skill:job_skill/archer/blast_shot/hit/damage2
