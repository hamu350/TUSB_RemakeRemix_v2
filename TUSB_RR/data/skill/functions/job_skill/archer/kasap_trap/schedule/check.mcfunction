#> skill:job_skill/archer/kasap_trap/schedule/check
### ルカナントラップの効果判定
### Copyright © 2022 赤石愛
...
execute as @e[distance=..3,type=#lib:mob,tag=Enemy,tag=!InKasap,sort=random,limit=3] run function skill:job_skill/archer/kasap_trap/schedule/apply
