#> skill:job_skill/knight/waltz/hit

execute as @e[tag=waltz] at @s run particle sweep_attack ~ ~ ~ 4 4 4 0.1 80 force
execute as @e[tag=waltz] at @s run function skill:job_skill/knight/waltz/otomitame
...
execute if data storage tusb_remake: {_:true} in minecraft:overworld run schedule function skill:job_skill/knight/waltz/hit 1t
