#> skill:job_skill/knight/iron_will/rollback
#
### Copyright © 2022 赤石愛
...
execute as @e[distance=..0.1,tag=IronWillPoint,sort=nearest,limit=1] run function skill:job_skill/knight/iron_will/rollback2
