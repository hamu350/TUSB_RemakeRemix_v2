#> skill:job_skill/summoner/blast_basin/schedule/hit
# きらきらタライが当たった時
### Copyright © 2022 赤石愛
...
### ダメージと吹き飛ばしを与える
execute as @e[distance=..8,type=#lib:mob,tag=Enemy] run function skill:job_skill/archer/blast_shot/hit/damage1
