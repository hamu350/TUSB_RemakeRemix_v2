#> skill:job_skill/summoner/summon_petit_black/cast
# ぷちブラックを召喚
### Copyright © 2022 赤石愛
...
execute align xyz positioned ~0.5 ~ ~0.5 positioned ~ ~-1 ~ run function skill:job_skill/summoner/summon_petit_black/place
