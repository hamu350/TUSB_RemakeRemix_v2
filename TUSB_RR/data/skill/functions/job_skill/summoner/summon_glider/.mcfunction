#> skill:job_skill/summoner/summon_glider/
# グライダーを召喚(6080)
### Copyright © 2022 赤石愛
...
### サモンバルーンの演出を有効化
execute in minecraft:overworld run schedule function skill:job_skill/summoner/summon_balloon/schedule/ 1t

### グライダーの操作を有効化
execute in minecraft:overworld run schedule function skill:job_skill/summoner/summon_glider/schedule/ 1t
