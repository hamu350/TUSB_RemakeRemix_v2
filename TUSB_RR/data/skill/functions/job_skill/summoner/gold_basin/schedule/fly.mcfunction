#> skill:job_skill/summoner/gold_basin/schedule/fly
### 金タライが飛んでいる演出
### Copyright © 2022 赤石愛
...
execute positioned ~-0.5 ~ ~-0.5 as @e[dy=0,type=#lib:mob,tag=Enemy,nbt=!{ActiveEffects:[{Id:23}]}] at @s run function skill:job_skill/summoner/gold_basin/schedule/hit
