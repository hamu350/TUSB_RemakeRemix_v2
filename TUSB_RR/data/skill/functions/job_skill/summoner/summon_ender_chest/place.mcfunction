#> skill:job_skill/summoner/summon_ender_chest/place
# エンダーチェストを召喚
### Copyright © 2022 赤石愛
...
execute unless block ~ ~ ~ ender_chest positioned ~-0.5 ~1 ~-0.5 if entity @s[dx=0] positioned ~0.5 ~ ~0.5 run function skill:job_skill/summoner/summon_ender_chest/place
