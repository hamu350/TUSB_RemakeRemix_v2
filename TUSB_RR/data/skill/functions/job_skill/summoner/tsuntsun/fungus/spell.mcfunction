#> skill:job_skill/summoner/tsuntsun/fungus/spell
# つんつん(キノコ棒)を詠唱(624X)
### Copyright © 2022 赤石愛
...
execute if score _ ActivatedSkill matches 6240..6249 run function skill:job_skill/summoner/tsuntsun/fungus/cast
