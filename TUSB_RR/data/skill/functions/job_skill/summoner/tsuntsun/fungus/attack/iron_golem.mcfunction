#> skill:job_skill/summoner/tsuntsun/fungus/attack/iron_golem
# アイアンゴーレムによる攻撃をかける
### Copyright © 2022 赤石愛
...
execute positioned ~-3 ~-2 ~-3 as @e[dx=6,dy=4,dz=6,type=#lib:mob,tag=Enemy] at @s unless block ~ ~-1 ~ minecraft:air run function score_damage:api/attack
