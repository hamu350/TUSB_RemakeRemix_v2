#> skill:job_skill/summoner/deal/cast
# ディール発動
### Copyright © 2022 赤石愛
...
execute as @e[distance=..30,type=#lib:mob,tag=Enemy] at @s if block ~ ~-1 ~ #minecraft:wool run function skill:job_skill/summoner/deal/apply
