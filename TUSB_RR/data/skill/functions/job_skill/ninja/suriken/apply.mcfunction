#> skill:job_skill/ninja/suriken/apply
### 雪玉を手裏剣にする
### Copyright © 2022 赤石愛
...
### 手裏剣カウントの有効化
execute in minecraft:overworld run schedule function skill:job_skill/ninja/suriken/count/ 1t

### 手裏剣の演出有効化
function skill:job_skill/ninja/suriken/schedule/
