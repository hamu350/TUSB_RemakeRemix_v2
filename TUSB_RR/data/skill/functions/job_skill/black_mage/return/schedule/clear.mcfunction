#> skill:job_skill/black_mage/return/schedule/clear
# ルーラ待機(507X)
### Copyright © 2022 赤石愛
### This software is released under the MIT License, see LICENSE.

### 丁度ならリターン
execute if score @s ReturnTimer = _ ReturnTimer run function skill:job_skill/black_mage/return/schedule/return
