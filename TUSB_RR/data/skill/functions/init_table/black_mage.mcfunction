...
data modify storage tusb_remake: _.10 set value {name:["§aマジカルエンゲージ"],level:[75],cost:90,description:[["自身にマジックシールド、マナリフ、エナジーセーブの効果を付与する"]]}
