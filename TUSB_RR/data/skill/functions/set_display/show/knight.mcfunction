...
execute if score @s ShowSkill matches 1050 run data modify storage tusb_remake: skill_name set value "§aウィルオブナイト"
...
execute if score @s ShowSkill matches 1280 run data modify storage tusb_remake: skill_name set value "§6ブレードワルツ"
