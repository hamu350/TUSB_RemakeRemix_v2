#> skill:set_display/show/white_mage
# 白魔導士スキル名称の表示
### Copyright © 2022 赤石愛
...
execute if score @s ShowSkill matches 4060 run data modify storage tusb_remake: skill_name set value "§aララバイ"
...
execute if score @s ShowSkill matches 4260 run data modify storage tusb_remake: skill_name set value "§dセイクリッドオーラ"
execute if score @s ShowSkill matches 4270 run data modify storage tusb_remake: skill_name set value "§6聖・ソウルイグニッション"
