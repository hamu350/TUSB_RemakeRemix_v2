...
execute if score @s Job matches 3 run function player_manager:job/load/archer
execute if score @s Job matches 4 run function player_manager:job/load/white_mage
