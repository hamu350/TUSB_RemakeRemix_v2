...
## モードチェンジ
execute if entity @s[advancements={tusb_remake:sign_event={mode_change_ruby=true}}] run function skill:display/mode/a
execute if entity @s[advancements={tusb_remake:sign_event={mode_change_sapphire=true}}] run function skill:display/mode/b
## インスタントチェンジ
execute if entity @s[advancements={tusb_remake:sign_event={instant_change_ruby=true}}] run function skill:display/instant/a
execute if entity @s[advancements={tusb_remake:sign_event={instant_change_sapphire=true}}] run function skill:display/instant/b

## リセットMP表示
execute if entity @s[advancements={tusb_remake:sign_event={reset_mp=true}}] run function player_manager:mp/reset_display

## ヘルクライムのリセット
execute if entity @s[advancements={tusb_remake:sign_event={hell_climb=true}}] run function world_manager:dimension/nether/athletic/hell_climb/start
## スピードランのリセット
execute if entity @s[advancements={tusb_remake:sign_event={speed_run=true}}] run function world_manager:dimension/nether/athletic/speed_run/start
## ライクスネークのリセット
execute if entity @s[advancements={tusb_remake:sign_event={like_snake=true}}] run function world_manager:dimension/nether/athletic/like_snake/start
execute if entity @s[advancements={tusb_remake:sign_event={like_snake_up=true}}] run function world_manager:dimension/nether/athletic/like_snake/return
