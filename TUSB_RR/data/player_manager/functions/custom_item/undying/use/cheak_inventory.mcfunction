#> player_manager:custom_item/undying/use/cheak_inventory
...
execute if data storage tusb_remake: test_array[0] run function player_manager:custom_item/undying/use/cheak_inventory
