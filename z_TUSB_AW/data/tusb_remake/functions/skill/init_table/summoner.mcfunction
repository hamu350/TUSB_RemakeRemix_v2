...
data modify storage tusb_remake: _.32 set value {name:["§6ファイナルカタストロフィ"],level:[150],cost:500,description:[["もっとも近い敵を中心に深淵の魔物を召喚する。召喚された魔物は周囲を一掃する。"]],condition:"ニンジン付きの棒を持って右クリック",range:[30]}
